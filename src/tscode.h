...
#define TSCODE_COMMAND_DEFAULT                                                                     \
    {                                                                                              \
        .type = TSCODE_COMMAND_INVALID, .channel = 0, .nonce = -1, .str = NULL, .speed = NULL,     \
 ...
 */
void tscode_process_ringbuffer(tscode_ringbuffer_t* buffer, tscode_command_callback_t callback,
 ...
 */
void tscode_process_stream_r(FILE* istream, FILE* ostream, tscode_command_callback_t callback,
                             char* istream_buf, size_t istream_buf_len, char* ostream_buf,
